...
// shizi
router.get('/shizi/:keyword', require('./routes/shizi/index'));
router.get('/shizi', require('./routes/shizi/index'));
...
// 上海卫健委
router.get('/gov/shanghai/wsjkw/:type?', require('./routes/gov/shanghai/wsjkw'));

// 395xe
router.get('/395xe/tupianqu/:type?', require('./routes/395xe/tupianqu'));

// thisav
router.get('/thisav/video/:type?', require('./routes/thisav/video'));
